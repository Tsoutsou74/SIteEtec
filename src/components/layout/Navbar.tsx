...
export default function Navbar() {
  ...
  // Remplacement de navigate(path) par la redirection native
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 md:gap-4">
          <Search size={15} className="cursor-pointer opacity-70 hover:opacity-100 transition" />
          
          <button
            onClick={() => handleNavigation('/log_in')}
            className="hidden sm:block text-[11px] font-bold px-3 md:px-4 py-2 rounded-xl border transition-all duration-300 cursor-pointer"
            style={{
